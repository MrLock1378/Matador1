...
local function info_cb(arg, data)
  ...
  lastname = ""
   ...
   local text = "▪️ Your name :_ *"..firstname.."*\n▪️ Your Lastname :_ *"..lastname.."*\n▪️ Your Username :_ "..username.."\n▪️ Your ID :_ *"..data.id_.."*\n\n"
